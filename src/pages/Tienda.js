    ...
    return (
        <>
            <section className="primera-necesidad__container">
                ...
                <div className="card text-center" style={{ width: '15rem' }}>
                    <img src="https://m.media-amazon.com/images/I/61XYW4EO0pL._AC_SL1500_.jpg" class="card-img-top" alt="Foto" />
                    <div className="card-body">
                ...
                <div className="card text-center" style={{ width: '15rem' }}>
                    <img src="https://www.impacto.com.pe/storage/products/md/1648658106.jpg" class="card-img-top" alt="Foto " />
                    <div className="card-body">
                ...
                <div className="card text-center" style={{ width: '16rem' }}>
                    <img src="https://media.kingston.com/kingston/product/ktc-product-ssd-kc600-1024gb-3-sm.jpg" class="card-img-top" alt="Foto " />
                    <div className="card-body"> 
            ...
            <section className="primera-necesidad__container">
                ...
                <div className="cards-conatiner" id="cardsContainer2">
                    <div className="card text-center" style={{ width: '15rem' }}>
                        <img src="https://lawgamers.com/wp-content/uploads/2019/05/OVERTURE-SERIES-VERDE-300x300.jpg" class="card-img-top" alt="Foto" />
                        <div className="card-body">
                    ...
                    <div className="card text-center" style={{ width: '15rem' }}>
                        <img src="https://lawgamers.com/wp-content/uploads/2021/10/SIERRA-GAMING-DESK.2jpg-300x300.jpg" class="card-img-top" alt="Foto" />
                        <div className="card-body">
                    ...
                    <div className="card text-center" style={{ width: '14.5rem' }}>
                        <img src="https://lawgamers.com/wp-content/uploads/2021/05/AKRacing_Silla_Premium_Series_Red_Plus-3521_1-300x300.jpg" class="card-img-top" alt="Foto" />
                        <div className="card-body">
                    ...
                    <div className="card text-center" style={{ width: '15rem' }}>
                        <img src="https://coolboxpe.vtexassets.com/arquivos/ids/191400-800-auto?v=637683547749300000&width=800&height=auto&aspect=true" class="card-img-top" alt="Foto" />
                        <div className="card-body">
