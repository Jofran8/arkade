        ...
        <nav className="header-nav">
          <div className="header-nav-container">
            <Link to="/" className="header-nav__logo-container">
              <img src="https://i.postimg.cc/G2wbqfdn/Logo-Sample-By-Tailor-Brands-1.jpg" alt="Logo Web" className="header-nav__logo" />
            </Link>
            ...
            <ul className="header-nav__link-list">
              <li className="header-nav__link-item">
                <Link to="/catalogo" className="header-nav__link">Catalogo</Link>
              </li>
              <li className="header-nav__link-item">
                <Link to="/nosotros" className="header-nav__link">Quienes Somos</Link>
              </li>
